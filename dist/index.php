        ...
        <div class="container-fluid p-0">
            ...
            <section class="resume-section" id="about">
                <div class="resume-section-content">
                    ...
                    <p class="lead mb-5">I am just an ordinary student at the Kalimantan Institute of Technology. My ID student number is 10221030, and I also reside in Balikpapan. I have never performed a somersault in.</p>
            ...
            <section class="resume-section" id="experience">
                <div class="resume-section-content">
                    ...
                    <div class="d-flex flex-column flex-md-row justify-content-between mb-5">
                        ...
                        {
                            if (!isValidateValues(array($_GET["sisi"]))) return;
                            global $luas;
                        ...
                        {
                            if (!isValidateValues(array($_GET["panjang"], $_GET["lebar"]))) return;
                            global $luas;
                        ...
                        {
                            if (!isValidateValues(array($_GET["alas"], $_GET["tinggi"]))) return;
                            global $luas;
                        ...
                        {
                            if (!isValidateValues(array($_GET["jari-jari"]))) return;
                            global $luas;
                        ...
                        {
                            if (!isValidateValues(array($_GET["panjang-atas"], $_GET["panjang-bawah"], $_GET["tinggi"]))) return;
                            global $luas;
                        ...
                        ?>
                            ...
                            <main class="container-content">
                                ...
                                <div class="container-result">
                                    ...
                                    echo isset($luas) ?
                                        '<div class="hasil">Luas ' . $namaBentukGeometri . ' adalah ' . round($luas, 2) . 'cm²</div>'
                                        :
                                        ''
                                    ?>
                                ...
                                <div class="jendela-bangun-container">
                                    ...
                                    <main class="jendela-bangun-options">
                                        <label for="kotak" class="option">
                                            <input type="radio" <?php if ($bentukGeometri == "kotak") echo "checked"; ?> name="bentuk-geometri" class="radio" value="kotak" id="kotak" data-shapeName="Kotak">
                                            <label for="kotak"></label>
                                            <p>Kotak</p>
                                            <img src="src/assets/kotak.svg" class="bentuk-geometri" alt="">
                                        </label>
                                        <label for="segitiga" class="option">
                                            <input type="radio" <?php if ($bentukGeometri == "segitiga") echo "checked"; ?> name="bentuk-geometri" class="radio" value="segitiga" id="segitiga" data-shapeName="Segitiga">
                                            <p>Segitiga</p>
                                            <img src="src/assets/segitiga.svg" class="bentuk-geometri" alt="">
                                        </label>
                                        <label for="lingkaran" class="option">
                                            <input type="radio" <?php if ($bentukGeometri == "lingkaran") echo "checked"; ?> name="bentuk-geometri" class="radio" value="lingkaran" id="lingkaran" data-shapeName="Lingkaran">
                                            <p>Lingkaran</p>
                                            <img src="src/assets/lingkaran.svg" class="bentuk-geometri" alt="">
                                        </label>
                                        <label for="persegi-panjang" class="option">
                                            <input type="radio" <?php if ($bentukGeometri == "persegi-panjang") echo "checked"; ?> name="bentuk-geometri" class="radio" value="persegi-panjang" id="persegi-panjang" data-shapeName="Persegi Panjang">
                                            <p>Persegi Panjang</p>
                                            <img src="src/assets/persegi_panjang.svg" class="bentuk-geometri" alt="">
                                        </label>
                                        <label for="trapesium" class="option">
                                            <input type="radio" <?php if ($bentukGeometri == "trapesium") echo "checked"; ?> name="bentuk-geometri" class="radio" value="trapesium" id="trapesium" data-shapeName="Trapesium">
                                            <p>Trapesium</p>
                                            <img src="src/assets/trapesium.svg" class="bentuk-geometri" alt="">
                                        </label>
                                        <label for="belah-ketupat" class="option">
                                            <input type="radio" <?php if ($bentukGeometri == "belah-ketupat") echo "checked"; ?> name="bentuk-geometri" class="radio" value="belah-ketupat" id="belah-ketupat" data-shapeName="Belah Ketupat">
                                            <p>Belah Ketupat</p>
